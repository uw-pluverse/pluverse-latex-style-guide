...
\newcommand{\xt}[1]{\NamedCommentTemplate{BlindColorTolSix}{XT}{#1}}
%\newcommand{\xt}[1]{\NamedCommentTemplate{BlindColorTolFive}{xxx}{#1}}
\newcommand{\hx}[1]{\NamedCommentTemplate{BlindColorTolFour}{Hongxu}{#1}}
